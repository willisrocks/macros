...
<div>
    <div class="form-group" style="margin-bottom: 2rem;">
        <label style="margin-right: 8px;">Choose roll type</label>
    ...
    buttons: {
      ok: {
        ...
        callback: async (html) => {
          ...
          whisperGM = html.find("#whisperGM")[0].checked;
          ...
          for (let a of targetActors) {
            ...
            switch (checkType) {
              ...
              case "ability":
                mod =
                  a.data.data.abilities[id].mod +
                  a.data.data.abilities[id].checkBonus;
...
function getCheckTemplate(checkType) {
  ...
  let template = `
    <div>
        <div class="form-group" style="margin-bottom: 2rem;">
            <label style="margin-right: 8px;">Choose check</label>
  ...
  template += `</select>
               <label style="margin: 0 8px;">Whisper GM? 
                 <input id="whisperGM" type="checkbox" style="vertical-align: middle; position: relative; bottom: 1px;" />
               </label>
        </div>
    </div>`;
